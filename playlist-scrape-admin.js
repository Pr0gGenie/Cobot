/* 
This script is for if you just want to directly scrape a user's playlist and you have
access directly to the code, simply enter the youtube account's handle WITHOUT THE @ symbol
into the <targetChannelHandle> variable
*/
